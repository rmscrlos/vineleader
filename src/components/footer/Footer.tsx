...
const Footer = () => {
	...
	return (
		<div className="mt-auto bg-foreground h-[20rem] text-background flex justify-around items-baseline  py-[5rem] w-auto md:flex-col md:h-auto md:gap-[5rem] md:justify-center md:items-center md:text-center">
